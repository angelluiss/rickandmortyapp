class FilterNameModel {
  FilterNameModel(
      {required this.info, required this.results, required this.error});
  late final Info info;
  late final List<Results> results;
  late final String error;

  FilterNameModel.fromJson(Map<String, dynamic> json) {
    info = Info.fromJson(json['info']);
    results =
        List.from(json['results']).map((e) => Results.fromJson(e)).toList();
  }

  FilterNameModel.withError(String errorMessage) {
    error = errorMessage;
  }
